    ...
    this.get = (dependency) => {
        if (dependencies[dependency] !== undefined) {
            ...
            if (config[curMode][dependency].new !== undefined && config[curMode][dependency].new) {
                ...
                dependencies[dependency] = args.length ? lib.ourTinyConstructor(args) : new lib();
            } else {
                dependencies[dependency] = require(getPath.bind(this)(config[curMode][dependency].require));
            }
